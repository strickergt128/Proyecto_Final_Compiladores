...
public class IoTLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SENSOR", "ACTUADOR", "VAR", "SI", "SINO", "MIENTRAS", "CADA", "ENCENDER", 
			"APAGAR", "AJUSTAR", "ENVIARSENAL", "LEERTEMPERATURA", "LEERHUMEDAD", 
	...
	public IoTLangLexer(CharStream input) {
		super(input);
